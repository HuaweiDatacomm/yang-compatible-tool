...
def prefix_to_modulename_and_revision(module, prefix, pos, errors, prefix_list = None):
    if prefix == '':
...
def prefix_to_module(module, prefix, pos, errors, prefix_list = None):
    if prefix == '':
        return module
    if prefix == module.i_prefix:
        return module
    modulename, revision = \
        prefix_to_modulename_and_revision(module, prefix, pos, errors, prefix_list)
